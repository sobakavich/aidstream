            ...
            <div class="col-lg-4 col-md-8 col-md-offset-2 form-body">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {{ Form::model(session('org_info'), ['url' => route('registration.save-organization'), 'method' => 'post']) }}
                        ...
                        <div class="input-wrapper">
                            ...
                            <div class="col-xs-12 col-md-12{{ $errors->get('organization_identifier') ? ' has-error' : '' }}">
                                {!! AsForm::select(['name' => 'organization_registration_agency', 'data' => $orgRegAgency, 'required' => true , 'parent' => 'col-xs-12 col-sm-6 col-md-6', 'empty_value' => 'Select an Agency', 'attr' => ['data-agency' => json_encode($orgRegAgency)]]) !!}
...
@else
    ...
    <script type="text/javascript">
        var agencies = JSON.parse($('#organization_registration_agency').attr('data-agency'));
        $(document).ready(function () {
