<div class="user-block clearfix" style="background-color: #EBF8FF; margin-bottom: 10px;">
    ...
    <div class="col-xs-12 col-md-12">
        {!! AsForm::select(['name' => 'user[' . $userIndex . '][user_permission]', 'label' => 'Permission Role', 'data' => $roles, 'empty_value' => 'Select a Role', 'required' => true , 'parent' => 'col-xs-12 col-sm-6 col-md-6']) !!}
    </div>
</div>
