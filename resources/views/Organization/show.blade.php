						...
						<div class="panel-body">
							...
							<div class="panel panel-default">
								<div class="panel-heading">Reporting Organization
									<a href="{{ url('/organization/' . Session::get('org_id') . '/reportingOrg') }}" class="edit-element">edit</a>
								</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">Organization Identifier
									<a href="{{ url('/organization/' . Session::get('org_id') . '/identifier')  }}" class="edit-element">edit</a>
								</div>
								<div class="panel-body panel-element-body row">
									<div class="col-xs-12 col-md-12">
							...
							<div class="panel panel-default">
								<div class="panel-heading">Name
									<a href="{{ url('/organization/' . Session::get('org_id') . '/name') }}" class="edit-element">edit</a>
								</div>
								<div class="panel-body panel-element-body row">
							...
							@if(!empty($total_budget))
								<div class="panel panel-default">
									<div class="panel-heading">Total Budget
										<a href="{{ route('organization.total-budget.index', Auth::user()->org_id) }}" class="edit-element">edit</a>
									</div>
											...
											<div class="panel panel-default">
												...
												<div class="panel-body panel-element-body row">
													...
													<div class="col-xs-12 col-md-12">
														...
														<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($totalBudget['value'][0]['value_date'])) }}</div>
													</div>
													<div class="col-xs-12 col-md-12">
											...
											<div class="panel panel-default">
												...
												<div class="panel-body panel-element-body row">
													<div class="col-xs-12 col-md-12">
														...
														<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($totalBudget['period_start'][0]['date'])) }}</div>
													</div>
												</div>
											</div>
											<div class="panel panel-default">
												...
												<div class="panel-body panel-element-body row">
													<div class="col-xs-12 col-md-12">
														<div class="col-xs-12 col-xs-4">Iso Date:</div>
														<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($totalBudget['period_end'][0]['date'])) }}</div>
													</div>
												</div>
											</div>
														...
														@foreach($totalBudget['budget_line'] as $budgetLine)
															...
															<div class="panel panel-default">
																...
																<div class="panel-body panel-element-body row">
																	...
																	<div class="col-xs-12 col-md-12">
																		<div class="col-xs-12 col-xs-4">Value Date:</div>
																		<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($budgetLine['value'][0]['value_date'])) }}</div>
																	</div>
																	<div class="col-xs-12 col-md-12">
																		<div class="col-xs-12 col-xs-4">Currency:</div>
						...
						@if(!empty($recipient_organization_budget))
							<div class="panel panel-default">
								<div class="panel-heading">Recipient Organization Budget
									<a href="{{ route('organization.recipient-organization-budget.index', Auth::user()->org_id)}}" class="edit-element">edit</a>
								</div>
									...
									@foreach($recipient_organization_budget as $recipientOrgBudget)
										...
										<div class="panel panel-default">
											...
											<div class="panel-body panel-element-body row">
												...
												<div class="col-xs-12 col-md-12">
													<div class="col-xs-12 col-xs-4">Value Date:</div>
													<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($recipientOrgBudget['value'][0]['value_date'])) }}</div>
												</div>
												<div class="col-xs-12 col-md-12">
													<div class="col-xs-12 col-xs-4">Currency:</div>
										...
										<div class="panel panel-default">
											...
											<div class="panel-body panel-element-body row">
												<div class="col-xs-12 col-md-12">
													<div class="col-xs-12 col-xs-4">Iso Date:</div>
													<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($recipientOrgBudget['period_start'][0]['date'])) }}</div>
												</div>
											</div>
										</div>
										<div class="panel panel-default">
											...
											<div class="panel-body panel-element-body row">
												<div class="col-xs-12 col-md-12">
													<div class="col-xs-12 col-xs-4">Iso Date:</div>
													<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($recipientOrgBudget['period_end'][0]['date'])) }}</div>
												</div>
											</div>
										</div>
										<div class="panel panel-default">
												...
												@foreach($recipientOrgBudget['budget_line'] as $recipientOrgBudgetLine)
													...
													<div class="panel panel-default">
														...
														<div class="panel-body panel-element-body row">
															...
															<div class="col-xs-12 col-md-12">
																<div class="col-xs-12 col-xs-4">Value Date:</div>
																<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($recipientOrgBudgetLine['value'][0]['value_date'])) }}</div>
															</div>
															<div class="col-xs-12 col-md-12">
																<div class="col-xs-12 col-xs-4">Currency:</div>
						...
						@if(!empty($recipient_country_budget))
							<div class="panel panel-default">
								<div class="panel-heading">Recipient Country
									<a href="{{ url('/organization/' . Session::get('org_id') . '/recipient-country-budget') }}" class="edit-element">edit</a>
								</div>
								<div class="panel-body panel-element-body row">
									@foreach($recipient_country_budget as $recipientCountryBudget)
										...
										<div class="panel panel-default">
											...
											<div class="panel-body panel-element-body row">
												...
												<div class="col-xs-12 col-md-12">
													<div class="col-xs-12 col-xs-4">Value Date:</div>
													<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($recipientCountryBudget['value'][0]['value_date'])) }}</div>
												</div>
												<div class="col-xs-12 col-md-12">
													<div class="col-xs-12 col-xs-4">Currency:</div>
										...
										<div class="panel panel-default">
											...
											<div class="panel-body panel-element-body row">
												<div class="col-xs-12 col-md-12">
													<div class="col-xs-12 col-xs-4">Iso Date:</div>
													<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($recipientCountryBudget['period_start'][0]['date'])) }}</div>
												</div>
											</div>
										</div>
										<div class="panel panel-default">
											...
											<div class="panel-body panel-element-body row">
												<div class="col-xs-12 col-md-12">
													<div class="col-xs-12 col-xs-4">Iso Date:</div>
													<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($recipientCountryBudget['period_end'][0]['date'])) }}</div>
												</div>
											</div>
										</div>
										<div class="panel panel-default">
												...
												@foreach($recipientCountryBudget['budget_line'] as $recipientCountryBudgetLine)
													...
													<div class="panel panel-default">
														...
														<div class="panel-body panel-element-body row">
															...
															<div class="col-xs-12 col-md-12">
																<div class="col-xs-12 col-xs-4">Value Date:</div>
																<div class="col-xs-12 col-xs-8">{{ date('M d, Y', strtotime($recipientCountryBudgetLine['value'][0]['value_date'])) }}</div>
															</div>
															<div class="col-xs-12 col-md-12">
																<div class="col-xs-12 col-xs-4">Currency:</div>
						...
						@if(!empty($document_link))
							<div class="panel panel-default">
								<div class="panel-heading">Document Link
									<a href="{{ url('/organization/' . Session::get('org_id') . '/document-link') }}" class="edit-element">edit</a>
								</div>
								<div class="panel-body panel-element-body row">
