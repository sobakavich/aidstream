                ...
                <div class="col-xs-12 col-md-8 col-lg-8 element-content-wrapper">
                    ...
                    <div class="panel panel-default panel-element-detail">
                        <div class="panel-body">
                            ...
                            @if(!empty($sectors))
                                <div class="panel panel-default">
                                    <div class="panel-heading">Sector
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-element-body">
                                                    @foreach($countryBudgetItem['budget_item'] as $budgetItem)
                                                        <div class="col-xs-12 col-md-12">
                                                            <div class="col-xs-12 col-sm-4">Code:</div>
                                                            <div class="col-xs-12 col-sm-8">{{$getCode->getActivityCodeName('BudgetIdentifier', $budgetItem['code'])}}</div>
                                                        </div>
                                                        <div class="col-xs-12 col-md-12">
                                                            <div class="col-xs-12 col-sm-4">Percentage:</div>
                            ...
                            @if(!empty($policyMakers))
                                <div class="panel panel-default">
                                    <div class="panel-heading">Policy Marker
                                        <a href="{{route('activity.policy-maker.index', $id)}}" class="edit-element">edit</a>
                                    </div>
                                    <div class="panel-body panel-level-1">
