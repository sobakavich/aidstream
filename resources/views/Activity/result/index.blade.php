                        ...
                        @if(count($results) > 0)
                            <div class="panel-action-btn">
                                <a href="{{ route('activity.result.create', $id) }}" class="btn btn-primary add-new-btn">Add New
                                    Result</a>
                                <a href="{{ route('import-result.index', $id) }}" class="btn btn-primary add-new-btn">Import Results</a>
                            </div>
                        @endif
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            ...
                            @else
                                <div class="text-center no-data no-result-data">
                                    ...
                                    <a href="{{ route('import-result.index', $id) }}" class="btn btn-primary">Import Results</a>
                                </div>
                            @endif
                        </div>
                    </div>
