    ...
    <div class="col-xs-9 col-md-9 col-lg-9 content-wrapper">
        ...
        <div class="col-xs-12 col-md-8 col-lg-8 element-content-wrapper">
            ...
            <div class="panel panel-default panel-element-detail element-show">
                ...
                @if($getCode->getActivityCodeName('SectorCategory', $project->sector[0]['sector_category_code']) != null)
                    <div class="panel-body">
                        <div class="panel-heading">
                            Sectors
                        </div>
                        <div class="col-xs-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                {{ $getCode->getActivityCodeName('SectorCategory', $project->sector[0]['sector_category_code'])}}
                            </div>
                        </div>
                    </div>
                @endif
