<div class="hidden col-sm-12" id="tz-location-clone">
    <div class="col-sm-4" id="region-wrap">
        ...
        {!! Form::select('location[index][administrative][0][code]', ['' => 'Select one of the following.'], ['class' => 'form-control region', 'required' => 'required']) !!}
    ...
    <div class="col-sm-4" id="district-wrap">
        ...
        {!! Form::select('location[index][administrative][1][code]', [], ['class' => 'form-control district', 'required' => 'required', 'disabled' => 'disabled']) !!}
