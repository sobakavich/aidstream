...
return [
    ...
    'activity_document_link_deleted' => sprintf(
        'Document Link has been deleted with id <a href="%s">":document_link_id"</a> from activity with id <a href="%s">":activity_id"</a>',
        route('activity.document-link.show', [':activity_id', ':document_link_id']),
        route('activity.show', ':activity_id')
    )
];
