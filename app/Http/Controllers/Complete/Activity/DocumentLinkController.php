...
class DocumentLinkController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $documentLinks = $activityData->documentLinks;
    ...
    public function destroy($id, $documentLinkId)
    {
        ...
        $response = ($this->documentLinkManager->delete($activityDocumentLink)) ? ['type' => 'success', 'code' => ['deleted', ['name' => 'Document Link']]] : [
            'type' => 'danger',
            'code' => ['delete_failed', ['name' => 'Document Link']]
        ];
