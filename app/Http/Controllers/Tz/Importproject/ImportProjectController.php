...
use App\Tz\Aidstream\Services\ImportProject\ImportProject;
...
class ImportProjectController extends Controller
{
    ...
    /**
     * @param ImportProject       $importManager
     * @param OrganizationManager $organizationManager
     * @internal param ImportActivity $importActivityManager
     */
    public function __construct(ImportProject $importManager, OrganizationManager $organizationManager)
    {
        $this->organizationId        = session('org_id');
        $this->organizationManager   = $organizationManager;
        $this->importActivityManager = $importManager;
    }
