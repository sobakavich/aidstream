...
class Description
{
     ...
     */
    const CSV_HEADER = ['activity_description_general' => 1, 'activity_description_objectives' => 2, 'activity_description_target_groups' => 3, 'activity_description_others' => 4];
...
//        $this->formatData();;
    ...
    {
        if (array_key_exists($key, self::CSV_HEADER)) {
