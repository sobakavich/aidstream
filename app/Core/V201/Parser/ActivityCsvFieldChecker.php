...
class ActivityCsvFieldChecker
{
                ...
                $validator->addReplacer(
                    ...
                    function ($message, $attribute, $rule, $parameters) use ($validator, $builder) {
                        ...
                        if ($activity) {
                            ...
                            $activityTitle = $activity->title ? json_decode($activity->title, true)[0]['narrative'] : json_decode($activity->identifier, true)['iati_identifier_text'];
    ...
    public function checkIdentifier()
    {
        ...
        $this->messages['activity_identifier.unique_activity_identifier'] = sprintf(
            'Duplicate Activity: The activity identifier is already in use. See <a href="%s" target="_blank">%s</a>.',
