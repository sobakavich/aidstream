...
class RegisterOrganization extends Request
{
    ...
    public function rules()
    {
        ...
        $rules['organization_registration_agency'] = 'required|code_list:Organization,OrganisationRegistrationAgency';
    ...
    public function messages()
    {
        ...
        $messages['organization_registration_agency.code_list']    = 'Organisation Registration Agency is not valid.';
