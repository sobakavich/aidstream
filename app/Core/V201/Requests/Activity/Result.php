...
class Result extends ActivityBaseRequest
{
     ...
     * @return array|mixed
     */
    public function getRulesForResult($formFields)
    {
        $rules = [];
     ...
     * @return array|mixed
     */
    public function getMessagesForResult($formFields)
    {
        $messages = [];
     ...
     * @return array|mixed
     */
    public function getRulesForIndicator($formFields, $formBase)
    {
        $rules = [];
     ...
     * @return array|mixed
     */
    public function getMessagesForIndicator($formFields, $formBase)
    {
        $messages = [];
     ...
     * @return array|mixed
     */
    public function getRulesForBaseline($formFields, $formBase)
    {
        $rules = [];
     ...
     * @return array|mixed
     */
    public function getMessagesForBaseline($formFields, $formBase)
    {
        $messages = [];
     ...
     * @return array|mixed
     */
    public function getRulesForPeriod($formFields, $formBase)
    {
        $rules = [];
     ...
     * @return array|mixed
     */
    public function getMessagesForPeriod($formFields, $formBase)
    {
        $messages = [];
     ...
     * @return array|mixed
     */
    public function getRulesForTarget($formFields, $formBase)
    {
        $rules = [];
     ...
     * @return array|mixed
     */
    public function getMessagesForTarget($formFields, $formBase)
    {
        $messages = [];
