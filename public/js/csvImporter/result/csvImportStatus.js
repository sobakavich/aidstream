...
var CsvImportStatusManager = {
    ...
    isTransferComplete: function () {
        CsvImportStatusManager.callAsync('/activity/' + activityId + '/import-result/check-status', 'GET').success(function (response) {
...
$(document).ready(function () {
    ...
    var interval = setInterval(function () {
        ...
        if (null == transferComplete) {
            window.location = '../activity/' + activityId + '/import-activity/upload-csv-redirect';
        }
